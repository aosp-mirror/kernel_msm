...
/* ChannelSelection data1 input (In CoolFlux) , */ \
	{0x450, "CHS3"}, \
/* Channel Selection data 2 input (coolflux input, */ \
	{0x461, "CHSA"}, \
/* Input selection for amplifier , */ \
	{0x481, "I2SDOC"}, \
/* Selection for I2S data out , */ \
	{0x4a0, "DISP"}, \
/* idp protection , */ \
	{0x4b0, "I2SDOE"}, \
/* Enable data output , */ \
...
/* Soft RampUp/Down mode for DCDC controller , */ \
	{0x800, "TROS"}, \
/* select external temperature also the */ \
	{0x818, "EXTTS"}, \
...
/* Setting polarity interupt , */ \
	{0x1000, "PDMSEL"}, \
/* Audio input interface mode , */ \
	{0x1010, "I2SMOUTEN"}, \
/* I2S Master enable (CLK and WS pads) , */ \
	{0x1021, "PDMORSEL"}, \
/* PDM Output right channel source selection , */ \
	{0x1041, "PDMOLSEL"}, \
/* PDM Output Left/Mono channel source selection , */ \
	{0x1061, "PADSEL"}, \
/* Output interface mode and ball selection , */ \
	{0x1100, "PDMOSDEN"}, \
/* Secure delay Cell , */ \
	{0x1110, "PDMOSDCF"}, \
/* Rising Falling Resync control Mux , */ \
	{0x1140, "SAAMEN"}, \
/* Speaker As a Mic feature ON/OFF , */ \
	{0x1150, "SAAMLPEN"}, \
/* speaker_as_mic low power mode (only in PDM_out mode), */ \
	{0x1160, "PDMOINTEN"}, \
/* PDM output interpolation ratio , */ \
	{0x1203, "PDMORG1"}, \
/* PDM Interpolator Right Channel DS4 G1 Gain Value , */ \
	{0x1243, "PDMORG2"}, \
/* PDM Interpolator Right Channel DS4 G2 Gain Value , */ \
	{0x1303, "PDMOLG1"}, \
/* PDM Interpolator Left Channel DS4 G1 Gain Value , */ \
	{0x1343, "PDMOLG2"}, \
/* PDM Interpolator Left Channel DS4 G2 Gain Value , */ \
	{0x2202, "SAAMGAIN"}, \
/* pga gain , */ \
	{0x2250, "SAAMPGACTRL"}, \
...
/* Calibration schedule (key2 protected) , */ \
	{0x8010, "MTPEX"}, \
/* (key2 protected) calibration of Ron has been executed, */ \
	{0x8045, "SWPROFIL"}, \
	{0x80a5, "SWVSTEP"}, \
...
/* Input selection for the second channel */ \
...
/* Setting for the part of the power transistor */ \
	{0x7a0, "boost_intel"}, \
/* Adaptive boost mode , */ \
	{0x7b0, "boost_speed"}, \
/* Soft RampUp/Down mode for DCDC controller , */ \
	{0x7c1, "ctrl_delay_comp_dcdc"}, \
/* delay compensation in current patg compared */ \
	{0x7e0, "boost_input"}, \
/* Selection intelligent boost detector input , */ \
	{0x7f0, "ctrl_supplysense"}, \
/* ADC10 input selection , */ \
	{0x800, "ext_temp_sel"}, \
/* select external temperature also the ext_temp */ \
	{0x818, "ext_temp"}, \
/* external temperature setting to be given by host , */ \
...
/* Secure delay Cell on clock path , */ \
	{0x1410, "data_secure_dly"}, \
/* Secure delay Cell enable on PDM data path , */ \
...
/* enables PGA test mode , */ \
	{0x2500, "pll_fcco"}, \
/* pll cco frequency , */ \
	{0x3000, "flag_hi_small"}, \
/* positive small window dcdc converter , */ \
	{0x3010, "flag_hi_large"}, \
/* positive large window dcdc converter , */ \
	{0x3020, "flag_lo_small"}, \
/* negative small window dcdc converter , */ \
	{0x3030, "flag_lo_large"}, \
/* negative large window dcdc converter , */ \
	{0x3040, "flag_voutcomp"}, \
/* flag_voutcomp, indication Vset is larger than Vbat, */ \
	{0x3050, "flag_voutcomp93"}, \
/* flag_voutcomp93, indication Vset is larger than 1.07* Vbat , */ \
	{0x3060, "flag_voutcomp86"}, \
/* flag_voutcomp86, indication Vset is larger than 1.14* Vbat , */ \
	{0x3070, "flag_hiz"}, \
/* flag_hiz, indication Vbst is larger than Vbat , */ \
	{0x3080, "flag_hi_peak"}, \
/* flag_hi_peak, indication hi_peak , */ \
	{0x3090, "flag_ocpokbst"}, \
/* flag_ocpokbst, indication no over */ \
	{0x30a0, "flag_peakcur"}, \
/* flag_peakcur, indication current is max in dcdc converter, */ \
	{0x30b0, "flag_ocpokap"}, \
/* flag_ocpokap, indication no over */ \
	{0x30c0, "flag_ocpokan"}, \
/* flag_ocpokan, indication no over */ \
	{0x30d0, "flag_ocpokbp"}, \
/* flag_ocpokbp, indication no over */ \
	{0x30e0, "flag_ocpokbn"}, \
/* flag_ocpokbn, indication no over */ \
	{0x30f0, "lost_clk"}, \
/* lost_clk, lost clock indication CGU , */ \
	{0x310f, "mtp_man_data_out"}, \
/* single word read from MTP (manual copy) , */ \
	{0x3200, "key01_locked"}, \
/* key01_locked, indication key 1 is locked , */ \
	{0x3210, "key02_locked"}, \
/* key02_locked, indication key 2 is locked , */ \
	{0x3225, "mtp_ecc_tcout"}, \
/* mtp_ecc_tcout , */ \
	{0x3280, "mtpctrl_valid_test_rd"}, \
/* mtp test readout for read , */ \
	{0x3290, "mtpctrl_valid_test_wr"}, \
/* mtp test readout for write , */ \
	{0x32a0, "flag_in_alarm_state"}, \
/* alarm state , */ \
	{0x32b0, "mtp_ecc_err2"}, \
/* two or more bit errors detected in MTP, can not reconstruct value, */ \
	{0x32c0, "mtp_ecc_err1"}, \
/* one bit error detected in MTP, reconstructed value, */ \
	{0x32d0, "mtp_mtp_hvf"}, \
/* high voltage ready flag for MTP , */ \
	{0x32f0, "mtp_zero_check_fail"}, \
/* zero check failed (tbd) for MTP , */ \
	{0x3300, "flag_adc10_ready"}, \
/* flag_adc10_ready, indication adc10 is ready , */ \
	{0x3310, "flag_clipa_high"}, \
/* flag_clipa_high, indication pmos amplifier "a" is clipping, */ \
	{0x3320, "flag_clipa_low"}, \
/* flag_clipa_low, indication nmos amplifier "a" is clipping, */ \
	{0x3330, "flag_clipb_high"}, \
/* flag_clipb_high, indication pmos amplifier "b" is clipping, */ \
	{0x3340, "flag_clipb_low"}, \
/* flag_clipb_low, indication nmos amplifier "b" is clipping, */ \
	{0x3359, "data_adc10_tempbat"}, \
/* adc 10 data output for testing , */ \
	{0x33f0, "flag_vddd_comp_nok"}, \
/* power switch flag 2 for testing , */ \
	{0x400f, "hid_code"}, \
/* hidden code , */ \
	{0x4100, "bypass_hp"}, \
/* Bypass_High Pass Filter , */ \
	{0x4110, "hard_mute"}, \
/* Hard Mute , */ \
	{0x4120, "soft_mute"}, \
/* Soft Mute , */ \
...
/* PWM Bitlength in noise shaper , */ \
	{0x4207, "ctrl_drive"}, \
/* drive bits to select amount of power stages amplifier, */ \
	{0x4281, "dpsalevel"}, \
/* DPSA Threshold level , */ \
	{0x42a1, "dpsa_release"}, \
/* DPSA Release time , */ \
	{0x42c0, "ctrl_coincidence"}, \
/* Prevent simultaneously switching of output stage , */ \
	{0x42d0, "ctrl_kickback"}, \
/* Prevent double pulses of output stage , */ \
	{0x42e0, "ctrl_test_sdeltaoffset"}, \
/* ctrl_test_sdeltaoffset , */ \
	{0x42f0, "ctrl_test_sdeltaclk"}, \
/* ctrl_test_sdeltaclk , */ \
	{0x4309, "ctrl_drivebst"}, \
/* Drive bits to select the powertransistor sections boost converter, */ \
	{0x43a0, "ctrl_ocptestbst"}, \
/* Boost OCP. , */ \
	{0x43c0, "enbl_hi_peak"}, \
/* enable for high peak comparator , */ \
...
/* OverCurrent Protection selection of power stage boost converter, */ \
...
/* Enable bit of hi (small) comparator , */ \
	{0x4440, "enbl_hi_large"}, \
/* Enable bit of hi (large) comparator , */ \
	{0x4450, "enbl_lo_small"}, \
/* Enable bit of lo (small) comparator , */ \
	{0x4460, "enbl_lo_large"}, \
/* Enable bit of lo (large) comparator , */ \
...
/* Enable hiz comparator , */ \
	{0x44c0, "enbl_pcdac"}, \
/* Enable peak current dac , */ \
	{0x44d0, "enbl_pccomp"}, \
/* Enable peak current comparator , */ \
	{0x44e0, "enbl_windac"}, \
/* Enable window dac , */ \
	{0x44f0, "enbl_powerbst"}, \
/* Enable line of the powerstage , */ \
	{0x4507, "ocp_thr"}, \
/* ocp_thr threshold level for OCP , */ \
...
/* Bypasslost_clk detector , */ \
	{0x45f0, "vpalarm"}, \
/* vpalarm (uvp ovp handling) , */ \
	{0x4600, "bypass_gc"}, \
/* bypass_gc, bypasses the CS gain correction , */ \
	{0x4610, "cs_gain_control"}, \
/* gain control by means of MTP or i2c , */ \
	{0x4627, "cs_gain"}, \
...
/* Switch protection on to prevent simultaniously */ \
	{0x4851, "clock_sh_sel"}, \
/* Clock SH selection , */ \
	{0x4876, "delay_se_neg"}, \
/* delay of se and neg , */ \
...
/* clock switch for battery protection clipper, */ \
	{0x4950, "ctrl_cs_8ohm"}, \
...
/* Invert se signal , */ \
	{0x49f0, "setse"}, \
/* switches between Single Ende and differentail mode, */ \
	{0x4a12, "ctrl_adc10_sel"}, \
/* select the input to convert the 10b ADC , */ \
	{0x4a60, "ctrl_adc10_reset"}, \
/* Global asynchronous reset (active HIGH) 10 bit ADC, */ \
	{0x4a81, "ctrl_adc10_test"}, \
/* Test mode selection signal 10 bit ADC , */ \
	{0x4aa0, "ctrl_bypass_lp_vbat"}, \
/* lp filter in batt sensor , */ \
	{0x4ae0, "ctrl_dc_offset"}, \
/* switch offset control on/off, is decimator offset control, */ \
	{0x4af0, "ctrl_tsense_hibias"}, \
/* bit to set the biasing in temp sensor to high , */ \
	{0x4b00, "ctrl_adc13_iset"}, \
/* Micadc Setting of current consumption. Debug use only, */ \
	{0x4b14, "ctrl_adc13_gain"}, \
/* Micadc gain setting (2-compl) , */ \
	{0x4b61, "ctrl_adc13_slowdel"}, \
/* Micadc Delay setting for internal clock. Debug use only, */ \
	{0x4b83, "ctrl_adc13_offset"}, \
/* Micadc ADC offset setting , */ \
	{0x4bc0, "ctrl_adc13_bsoinv"}, \
/* Micadc bit stream output invert mode for test , */ \
	{0x4bd0, "ctrl_adc13_resonator_enable"}, \
/* Micadc Give extra SNR with less stability. Debug use only, */ \
	{0x4be0, "ctrl_testmicadc"}, \
/* Mux at input of MICADC for test purpose , */ \
	{0x4c0f, "ctrl_offset"}, \
/* offset control for ABIST testing , */ \
	{0x4d05, "ctrl_windac"}, \
...
/* for testing direct control slopecur , */ \
	{0x4e53, "ctrl_dem"}, \
/* dyn element matching control, rest of codes are optional, */ \
	{0x4e93, "ctrl_demmismatch"}, \
/* dyn element matching add offset , */ \
	{0x4ed0, "enbl_pwm_dcc"}, \
/* to enable direct control of pwm duty cycle , */ \
	{0x5007, "gain"}, \
/* gain setting of the gain multiplier gain */ \
	{0x5081, "ctrl_sourceb"}, \
/* Set OUTB to , */ \
	{0x50a1, "ctrl_sourcea"}, \
/* Set OUTA to , */ \
	{0x50c1, "ctrl_sourcebst"}, \
/* Sets the source of the pwmbst output to */ \
	{0x50e1, "ctrl_test_mono"}, \
/* ABIST mode to add both amplifier halfs */ \
	{0x5104, "pulselengthbst"}, \
/* pulselength setting test input for boost converter , */ \
	{0x5150, "ctrl_bypasslatchbst"}, \
/* bypass_latch in boost converter , */ \
	{0x5160, "invertbst"}, \
/* invert pwmbst test signal , */ \
	{0x5174, "pulselength"}, \
/* pulselength setting test input for amplifier , */ \
	{0x51c0, "ctrl_bypasslatch"}, \
/* bypass_latch in boost convert , */ \
	{0x51d0, "invertb"}, \
/* invert pwmb test signal , */ \
	{0x51e0, "inverta"}, \
/* invert pwma test signal , */ \
	{0x51f0, "ctrl_bypass_ctrlloop"}, \
/* bypass_ctrlloop bypasses the control loop of the amplifier, */ \
	{0x5200, "ctrl_test_discrete"}, \
/* tbd for rdson testing , */ \
...
/* Digimux TEST2 out. output flag_clipa_low */ \
	{0x5383, "ctrl_digimux_out_data1"}, \
/* Digimux DATA1 out (output flag_clipb_high */ \
	{0x53c3, "ctrl_digimux_out_data3"}, \
/* Digimux DATA3 out (output flag_clipx_x */ \
	{0x5400, "hs_mode"}, \
/* hs_mode, high speed mode I2C bus , */ \
	{0x5412, "test_parametric_io"}, \
/* test_parametric_io for testing pads , */ \
	{0x5440, "enbl_ringo"}, \
/* enbl_ringo, for test purpose to check with ringo , */ \
	{0x5480, "ctrl_cliplevel"}, \
/* Clip level , */ \
	{0x5491, "ctrl_anamux_sel"}, \
/* anamux selection , */ \
	{0x54b0, "test_vdddsw_dio"}, \
/* to overrule the power switches for memory , */ \
	{0x54c0, "ctrl_bypass_diosw_ovp"}, \
/* To disable the overvoltage protection of vddd_dio_sw, */ \
	{0x54d0, "test_vddd_sw"}, \
/* test vdd sw , */ \
	{0x54e0, "test_vddd_sw_comp"}, \
/* test vdd sw comp , */ \
	{0x550e, "enbl_amp"}, \
/* enbl_amp for testing to enable all analoge blocks in amplifier, */ \
	{0x55f0, "fr_fsp"}, \
/* extr free running clock mode for testing , */ \
	{0x5600, "use_direct_ctrls"}, \
/* use_direct_ctrls, to overrule several functions direct for testing, */ \
	{0x5610, "rst_datapath"}, \
/* rst_datapath, datapath reset , */ \
	{0x5620, "rst_cgu"}, \
/* rst_cgu, cgu reset , */ \
	{0x5637, "enbl_ref"}, \
/* for testing to enable all analoge blocks in references, */ \
	{0x56b0, "enbl_engage"}, \
/* Enable output stage amplifier , */ \
	{0x56c0, "use_direct_clk_ctrl"}, \
/* use_direct_clk_ctrl, to overrule several functions direct for testing, */ \
	{0x56d0, "use_direct_pll_ctrl"}, \
/* use_direct_pll_ctrl, to overrule several functions direct for test, */ \
	{0x56e0, "use_direct_ctrls_2"}, \
/* use_direct_sourseamp_ctrls, to overrule */ \
	{0x5707, "ctrl_anamux_out_test1"}, \
/* Anamux control , */ \
	{0x5782, "ctrl_zero"}, \
/* Bandwith control feedbackloop , */ \
	{0x57b0, "enbl_ldo_stress"}, \
/* LDO stress function frinch capacitors , */ \
	{0x57c0, "ctrl_ocptest"}, \
/* ctrl_ocptest, deactivates the over currentprotection in the */ \
	{0x57e0, "ctrl_otptest"}, \
/* otptest, test mode otp amplifier , */ \
	{0x57f0, "ctrl_reverse"}, \
/* CTRL revers , */ \
	{0x5802, "pll_mdec_msb"}, \
/* most significant bits pll_mdec , */ \
	{0x5833, "pll_selr"}, \
/* pll_selr , */ \
	{0x5874, "pll_selp"}, \
/* pll_selp , */ \
...
/* pll_bypass , */ \
	{0x5a0f, "tsig_freq"}, \
/* tsig_freq, internal sinus test generator, frequency control, */ \
...
/* control ADC10 , */ \
	{0x5c01, "pll_ndec_msb"}, \
/* most significant bits of pll_ndec , */ \
	{0x5c2d, "pll_mdec"}, \
/* bits 13..0 of pll_mdec , */ \
	{0x5d06, "pll_pdec"}, \
/* pll_pdec , */ \
	{0x5d87, "pll_ndec"}, \
/* bits 7..0 of pll_ndec , */ \
...
/* PDM resynchronization bypass , */ \
	{0x6007, "MTP_key1"}, \
/* MTP Key1 , */ \
	{0x6185, "mtp_ecc_tcin"}, \
/* Mtp_ecc_tcin , */ \
	{0x6203, "mtp_man_address_in"}, \
/* address from i2cregs for writing one word single mtp, */ \
	{0x6260, "mtp_ecc_eeb"}, \
/* enable code bit generation (active low!) , */ \
	{0x6270, "mtp_ecc_ecb"}, \
/* enable correction signal (active low!) , */ \
	{0x6280, "man_copy_mtp_to_iic"}, \
/* start copying single word from mtp to i2cregs_mtp , */ \
	{0x6290, "man_copy_iic_to_mtp"}, \
/* start copying single word from i2cregs_mtp to mtp [Key 1 protected], */ \
	{0x62a0, "auto_copy_mtp_to_iic"}, \
/* start copying all the data from mtp to i2cregs_mtp, */ \
	{0x62b0, "auto_copy_iic_to_mtp"}, \
/* start copying all the data from i2cregs_mtp to mtp [Key 2 protected], */ \
	{0x62d2, "mtp_speed_mode"}, \
/* Speed mode , */ \
	{0x6340, "mtp_dircet_enable"}, \
/* mtp_direct_enable (key1 protected) , */ \
	{0x6350, "mtp_direct_wr"}, \
/* mtp_direct_wr (key1 protected) direct value for */ \
	{0x6360, "mtp_direct_rd"}, \
/* mtp_direct_rd (key1 protected) direct value for */ \
	{0x6370, "mtp_direct_rst"}, \
/* mtp_direct_rst (key1 protected) direct value for */ \
	{0x6380, "mtp_direct_ers"}, \
/* mtp_direct_ers (key1 protected) direct value for */ \
	{0x6390, "mtp_direct_prg"}, \
/* mtp_direct_prg (key1 protected) direct value for */ \
	{0x63a0, "mtp_direct_epp"}, \
/* mtp_direct_epp (key1 protected) direct value for */ \
	{0x63b4, "mtp_direct_test"}, \
/* mtp_direct_test (key1 protected) , */ \
	{0x640f, "mtp_man_data_in"}, \
/* single wordt be written to MTP (manual copy) , */ \
	{0x7000, "cf_rst_dsp"}, \
/* Reset CoolFlux DSP , */ \
	{0x7011, "cf_dmem"}, \
/* Target memory for access , */ \
