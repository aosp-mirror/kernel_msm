...
#define nxpTfa2BfEnumList_t enum nxpTfa2BfEnumList
...
/* Switch on the class-D power sections */\
...
/* Current sense common mode feedback */\
...
/* Connect current sense negative */\
	{0x8670, "enbl_cs_nofloating_p_left"}, \
/* Connect current sense positive */\
...
/* Connect current sense negative to gnda */\
	{0x8770, "enbl_cs_nofloating_p_right"}, \
/* Connect current sense positive to gnda */\
...
/* All odd rows of the faim are selected, */\
...
/* Direct control for cgu reset , */\
	{0xc038, "enbl_ref"}, \
/* Switch on the analog references, */\
	{0xc0d0, "enbl_ringo"}, \
...
/* CVI testing - boost power stage , */\
	{0xc4d0, "test_bst_ocp"}, \
/* Boost OCP. For old ocp */\
	{0xc4e0, "test_bst_sense"}, \
/*	Test option for the sense NMOS */\
	{0xc500, "test_cvi"}, \
/* Analog BIST, switch choose */\
...
/* Vddd core power switch control - overrules the manager control, */\
	{0xc707, "digimuxa_sel"}, \
/* DigimuxA input selection control */\
	{0xc787, "digimuxb_sel"}, \
/* DigimuxB input selection control */\
	{0xc807, "digimuxc_sel"}, \
/* DigimuxC input selection control */\
	{0xc887, "digimuxd_sel"}, \
/* DigimuxD input selection control */\
	{0xc901, "dio1_ehs"}, \
/* Speed/load setting for DIO1 IO cell, */\
	{0xc921, "dio2_ehs"}, \
/* Speed/load setting for DIO2 IO cell, */\
	{0xc941, "gainio_ehs"}, \
/* Speed/load setting for GAINIO cell, */\
	{0xc961, "pdmo_ehs"}, \
/* Speed/load setting for PDMO IO cell, */\
	{0xc981, "int_ehs"}, \
/* Speed/load setting for INT IO cell, */\
	{0xc9a1, "tdo_ehs"}, \
/* Speed/load setting for TDO IO cell, */\
	{0xc9c0, "hs_mode"}, \
