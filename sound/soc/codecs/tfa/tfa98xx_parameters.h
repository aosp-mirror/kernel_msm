...
/* These warnings are disabled because it is
 * only given by Windows and there is no easy fix
 */
...
/* This marker is used to indicate if all
 * msgs need to be written to the device
 */
...
/*
 * for 24 bit value using 3 bytes
 */
#define uint24_t struct uint24
struct uint24 {
	uint8_t b[3];
};
/*
 ...
 */
#define nxpTfaHeader_t struct nxpTfaHeader
struct nxpTfaHeader {
	uint16_t id;
...
#define nxpTfaSamplerate_t enum nxpTfaSamplerate
 ...
 */
#define nxpTfaDspMem_t struct nxpTfaDspMem
struct nxpTfaDspMem {
 ...
 */
#define nxpTfaBiquad_t struct nxpTfaBiquad
struct nxpTfaBiquad {
	int a2;
	int a1;
	int b2;
...
#define nxpTfaBiquadOld_t struct nxpTfaBiquadOld
struct nxpTfaBiquadOld {
	uint8_t bytes[BIQUAD_COEFF_SIZE * sizeof(uint24_t)];
};

#define nxpTfaBiquadFloat_t struct nxpTfaBiquadFloat
 ...
 */
#define nxpTfaFilterType_t enum nxpTfaFilterType
 ...
 */
#define nxpTfaFilter_t struct nxpTfaFilter
struct nxpTfaFilter {
 ...
 */
#define nxpTfaLsCompensationFilter_t struct nxpTfaLsCompensationFilter
struct nxpTfaLsCompensationFilter {
	nxpTfaBiquad_t biquad;
	uint8_t lsCompOn;
	/* Loudspeaker compensation on/off;
	 * when 'off', the DSP code doesn't apply
	 * the bwExt => bwExtOn GUI flag should
	 * be gray to avoid confusion
	 */
 ...
 */
#define nxpTfaAntiAliasFilter_t struct nxpTfaAntiAliasFilter
 ...
 */
#define nxpTfaIntegratorFilter_t struct nxpTfaIntegratorFilter
...
#define nxpTfaEqFilter_t struct nxpTfaEqFilter
...
#define nxpTfaContAntiAlias_t struct nxpTfaContAntiAlias
struct nxpTfaContAntiAlias {
	int8_t index;
	/*
	 * < index determines destination
	 * type; anti-alias, integrator,eq
	 */
	uint8_t type;
	float cutOffFreq; /* cut off frequency */
	float samplingFreq;
...
#define nxpTfaContIntegrator_t struct nxpTfaContIntegrator
...
#define nxpTfaContEq_t struct nxpTfaContEq
struct nxpTfaContEq {
	int8_t index;
	uint8_t type; /* (== enum FilterTypes, assure 8bits length) */
	float cutOffFreq; /* cut off frequency, range: [100.0 4000.0] */
...
#define nxpTfaContBiquad_t union nxpTfaContBiquad
...
#define nxpTfaEqualizer_t struct nxpTfaEqualizer
...
#define nxpTfaHeaderType_t enum nxpTfaHeaderType
...
#define nxpTfaEqualizerFile_t struct nxpTfaEqualizerFile
...
#define nxpTfaPatch_t struct nxpTfaPatchFile
 ...
 *  - the payload of this file includes the opcode
 *  and is send straight to the DSP
 */
#define NXPTFA_MG_VERSION  '3'
#define NXPTFA_MG_SUBVERSION "00"
#define nxpTfaMsgFile_t struct nxpTfaMsgFile
...
#define nxpTfaConfigS1_t struct nxpTfaConfigS1File
...
#define nxpTfaConfigS2_t struct nxpTfaConfigS2File
...
#define nxpTfaConfigS3_t struct nxpTfaConfigS3File
...
#define nxpTfaConfig_t struct nxpTfaConfigFile
...
#define nxpTfaPreset_t struct nxpTfaPresetFile
...
#define nxpTfaDrc_t struct nxpTfaDrcFile
...
#define nxpTfaDrc2_t struct nxpTfaDrcFile2
...
#define nxpTfaVolumeStep1_t struct nxpTfaVolumeStep1
...
#define nxpTfaVolumeStep2_t struct nxpTfaVolumeStep2
...
#define nxpTfaVolumeStepFile_t struct nxpTfaVolumeStepFile
 ...
 * volumestep2 file
 */
#define nxpTfaVolumeStep2File_t struct nxpTfaVolumeStep2File
 ...
 * volumestepMax2 file
 */
#define nxpTfaVolumeStepMax2File_t struct nxpTfaVolumeStepMax2File
 ...
 */
#define nxpTfaVolumeStepMax2_1File_t struct nxpTfaVolumeStepMax2_1File
 ...
 */
#define nxpTfaOldHeader_t struct nxpTfaOldHeader
...
#define nxpTfaOldFilter_t struct nxpOldTfaFilter
...
#define nxpTfaOldVolumeStep2_t struct nxpTfaOldVolumeStep2
struct nxpTfaOldVolumeStep2 {
	float attenuation; /* IEEE single float */
	uint8_t preset[TFA98XX_PRESET_LENGTH];
	nxpTfaOldFilter_t eq[10];
};
#define nxpTfaOldVolumeStep2File_t struct nxpTfaOldVolumeStepFile
...
#define nxpTfaSpeakerFile_t struct nxpTfaSpeakerFile
...
#define nxpTfaLiveData_t struct nxpTfaLiveData
 ...
 * descriptors
 */
#define nxpTfaDescriptorType_t enum nxpTfaDescriptorType
...
#define nxpTfaDescPtr_t struct nxpTfaDescPtr
struct nxpTfaDescPtr {
	uint32_t offset :24;
	uint32_t type :8;
/* (== enum nxpTfaDescriptorType, assure 8bits length) */
};

/*
 * generic file descriptor
 */
#define nxpTfaFileDsc_t struct nxpTfaFileDsc
 ...
 */
#define nxpTfaDeviceList_t struct nxpTfaDeviceList
 ...
 */
#define nxpTfaProfileList_t struct nxpTfaProfileList
 ...
 */
#define nxpTfaLiveDataList_t struct nxpTfaLiveDataList
 ...
 * Bitfield descriptor
 */
#define nxpTfaBitfield_t struct nxpTfaBitfield
 ...
 */
#define nxpTfaBfEnum_t struct nxpTfaBfEnum
struct nxpTfaBfEnum {
 ...
 */
#define nxpTfaRegpatch_t struct nxpTfaRegpatch
 ...
 * Mode descriptor
 */
#define nxpTfaMode_t struct nxpTfaUseCase
 ...
 * NoInit descriptor
 */
#define nxpTfaNoInit_t struct nxpTfaNoInit
struct nxpTfaNoInit {
 ...
 * Features descriptor
 */
#define nxpTfaFeatures_t struct nxpTfaFeatures
struct nxpTfaFeatures {
	uint16_t value[3]; /* features value */
};

#define nxpTfaCmd_t struct nxpTfaCmd
struct nxpTfaCmd {
	uint16_t id;
...
#define nxpTfaContainer_t struct nxpTfaContainer
