...
/* CITADEL_INPUT is AP->AB, CITADEL_LOCKOUT is AB->AP, they are intended
 * to use the same register
 */
#define CITADEL_INPUT_DATA_ADDR SYSREG_AON_IPU_REG6
#define CITADEL_INPUT_DATA2_ADDR SYSREG_AON_IPU_REG7
...
#define AB_EXCEPTION_NUM_ADDR SYSREG_AON_IPU_REG9
#define AB_FAULT_ADDR SYSREG_AON_IPU_REG10
#define AB_LINK_REG SYSREG_AON_IPU_REG11
#else
...
#define CITADEL_INPUT_DATA2_ADDR (CITADEL_INPUT_DATA_ADDR + 0x4)
...
#define AB_EXCEPTION_NUM_ADDR (CITADEL_OUTPUT_DATA2_ADDR + 0x4)
#define AB_FAULT_ADDR (AB_EXCEPTION_NUM_ADDR + 0x4)
#define AB_LINK_REG (AB_FAULT_ADDR + 0x4)
...
#define CITADEL_TOKEN_ADDR           0x21FFFD00
...
#define CALIBRATION_DATA_SIZE 0x400
#define INPUT_ADDR_END (CALIBRATION_DATA_ADDR + CALIBRATION_DATA_SIZE)
