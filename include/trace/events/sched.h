...
DECLARE_EVENT_CLASS(sched_cpu_load,
	...
	TP_printk("cpu %u idle %d nr_run %u nr_big %u lsf %u capacity %u"
	" cr_avg %llu"
	" irqload %llu fmax %u power_cost %u cstate %d dstate %d",
...
TRACE_EVENT(sched_load_to_gov,
	...
	TP_printk("cpu=%d policy=%d ed_task_pid=%d "
		"aggr_grp_load=%llu "
		"freq_aggr_thresh=%llu tt_load=%llu "
		"rq_ps=%llu "
		"grp_rq_ps=%llu"
		" nt_ps=%llu grp_nt_ps=%llu pl=%llu load=%llu "
		"big_task_rotation=%d "
		"sysctl_sched_little_cluster_coloc_fmin_khz=%u"
		" coloc_boost_load=%llu",
