#ifndef __TI_DRV2625_H__
#define __TI_DRV2625_H__
/*
...
#define	DRV2625_MODE_MASK			0x03
#define	DRV2625_MODE_RTP			0x00
#define	DRV2625_MODE_WAVEFORM_SEQUENCER		0x01
#define	DRV2625_MODE_DIAGNOSTIC			0x02
#define	DRV2625_MODE_CALIBRATION		0x03
...
#define FB_BRK_FACTOR_MASK			0x70
#define FB_BRK_FACTOR_SHIFT			0x04
#define LOOP_GAIN_MASK				0x0c
#define LOOP_GAIN_SHIFT				0x02
...
#define DRV2625_REG_BRK_TIME			0x28
#define BRK_TIME_MASK				0xf0
#define BRK_TIME_SHIFT				0x04
#define IDISS_TIME_MASK				0x0f

#define DRV2625_REG_OD_CLAMP_TIME		0x29
#define SAMPLE_TIME_MASK			0x0c
#define SAMPLE_TIME_SHIFT			0x02
...
struct drv2625_waveform_sequencer {
	...
	struct drv2625_waveform msWaveform[DRV2625_SEQUENCER_SIZE];
};

struct drv2625_seq_loop {
	enum wave_seq_loop mpLoop[DRV2625_SEQUENCER_SIZE];
};

struct drv2625_wave_seq {
	unsigned char mpWaveIndex[DRV2625_SEQUENCER_SIZE];
};
...
#define	DRV2625_SET_SEQ_LOOP    _IOWR(DRV2625_MAGIC_NUMBER, 1, struct drv2625_seq_loop *)
#define	DRV2625_SET_MAIN        _IOWR(DRV2625_MAGIC_NUMBER, 2, struct drv2625_wave_setting *)
#define	DRV2625_SET_WAV_SEQ     _IOWR(DRV2625_MAGIC_NUMBER, 3, struct drv2625_wave_seq *)
#define	DRV2625_WAVSEQ_PLAY     _IOWR(DRV2625_MAGIC_NUMBER, 4, unsigned long)
#define	DRV2625_STOP            _IOWR(DRV2625_MAGIC_NUMBER, 5, unsigned long)
#define	DRV2625_RUN_DIAGNOSTIC  _IOWR(DRV2625_MAGIC_NUMBER, 6, unsigned long)
#define	DRV2625_GET_DIAGRESULT  _IOWR(DRV2625_MAGIC_NUMBER, 7, struct drv2625_diag_result *)
#define	DRV2625_RUN_AUTOCAL     _IOWR(DRV2625_MAGIC_NUMBER, 8, unsigned long)
#define	DRV2625_GET_CALRESULT   _IOWR(DRV2625_MAGIC_NUMBER, 9, struct drv2625_autocal_result *)
