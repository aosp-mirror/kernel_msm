...
#define IAXXX_PAD_CTRL_LOW_PWR_VAL \
		...
		(0 << IAXXX_PAD_CTRL_CDC_I2C_SCL_STRENGTH_POS))
...
#define IAXXX_PAD_CTRL_PORTA_CLK_LOW_PWR     IAXXX_PAD_CTRL_LOW_PWR_VAL
#define IAXXX_PAD_CTRL_CDC_MCLK_LOW_PWR \
		((0 << IAXXX_PAD_CTRL_CDC_MCLK_DDST_POS) | \
		(1 << IAXXX_PAD_CTRL_CDC_MCLK_REN_POS))
#define IAXXX_PAD_CTRL_CDC_PDM0_LOW_PWR \
		((0 << IAXXX_PAD_CTRL_CDC_PDM0_DDST_POS) | \
		(1 << IAXXX_PAD_CTRL_CDC_PDM0_REN_POS))
#define IAXXX_PAD_CTRL_CDC_PDM1_LOW_PWR \
		((0 << IAXXX_PAD_CTRL_CDC_PDM1_DDST_POS) | \
		(1 << IAXXX_PAD_CTRL_CDC_PDM1_REN_POS))
#define IAXXX_PAD_CTRL_CDC_PDM2_LOW_PWR \
		((0 << IAXXX_PAD_CTRL_CDC_PDM2_DDST_POS) | \
		(1 << IAXXX_PAD_CTRL_CDC_PDM2_REN_POS))
