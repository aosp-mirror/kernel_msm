 ...
 *****************************************************************************/
enum {
	IAXXX_SYSID_RESOURCE_TYPE_SPECIAL = 0x0,	/* For special use */
	IAXXX_SYSID_RESOURCE_TYPE_DRIVER,		/* device drivers */
	IAXXX_SYSID_RESOURCE_TYPE_MODULE,		/* module instances */
	IAXXX_SYSID_RESOURCE_TYPE_PLUGIN,		/* Plugin instances */
	IAXXX_SYSID_RESOURCE_TYPE_CHANNEL,		/* Channels */
	IAXXX_SYSID_RESOURCE_TYPE_TUNNEL,		/* Tunnels */
	IAXXX_SYSID_RESOURCE_TYPE_STREAM,		/* Streams */
	IAXXX_SYSID_RESOURCE_TYPE_DEVICE,		/* Peripherals */
...
enum sysid_driver_type_e {
	...
	IAXXX_SYSID_DRIVER_TYPE_I2C,		/* I2C driver */
	IAXXX_SYSID_DRIVER_TYPE_SPI,		/* SPI driver */
	IAXXX_SYSID_DRIVER_TYPE_UART,		/* UART driver */
	IAXXX_SYSID_DRIVER_TYPE_SLIMBUS_CTRL,	/* SLIMBUS control driver */
	IAXXX_SYSID_DRIVER_TYPE_SOUNDWIRE_CTRL,	/* SoundWire control driver */
	IAXXX_SYSID_DRIVER_TYPE_I3C_CTRL,	/* I3C driver */
	IAXXX_SYSID_DRIVER_TYPE_PCM,		/* PCM driver */
	IAXXX_SYSID_DRIVER_TYPE_PDM_IN,		/* PDM input driver */
	IAXXX_SYSID_DRIVER_TYPE_PDM_OUT,	/* PDM output driver */
	IAXXX_SYSID_DRIVER_TYPE_I2S,		/* I2S driver */
	IAXXX_SYSID_DRIVER_TYPE_SLIMBUS_DATA,	/* SLIMBUS data driver */
	IAXXX_SYSID_DRIVER_TYPE_SOUNDWIRE_DATA,	/* SoundWire data driver */
	...
	IAXXX_SYSID_DRIVER_TYPE_FILTER_OUT,	/* Filter output driver */
	IAXXX_SYSID_DRIVER_TYPE_STMR_TIMER,	/* STRM timer driver */
	IAXXX_SYSID_DRIVER_TYPE_STMR_PT,/* STMR presentation timer driver */
	IAXXX_SYSID_DRIVER_TYPE_SW_TIMER,	/* Timer driver */
	IAXXX_SYSID_DRIVER_TYPE_TIMER,		/* WCPT Timer driver */
	IAXXX_SYSID_DRIVER_TYPE_PLL,		/* PLL driver */
	IAXXX_SYSID_DRIVER_TYPE_DMA,		/* DMA driver */
	IAXXX_SYSID_DRIVER_TYPE_GPIOA,		/* GPIO-A driver */
	IAXXX_SYSID_DRIVER_TYPE_GPIOB,		/* GPIO-B driver */
	IAXXX_SYSID_DRIVER_TYPE_REGMAP,		/* Register Map driver */
	IAXXX_SYSID_DRIVER_TYPE_FLASHDRV,	/* Flash driver */
	IAXXX_SYSID_DRIVER_TYPE_BUTTON,		/* Button driver */
	IAXXX_SYSID_DRIVER_TYPE_LED,		/* LED driver */
	IAXXX_SYSID_DRIVER_TYPE_ADAU1361,	/* ADAU1361 driver */
	IAXXX_SYSID_DRIVER_TYPE_USBDRV,		/* USB driver */
	IAXXX_SYSID_DRIVER_TYPE_CSR8811,	/* CSR8811 driver */
	IAXXX_SYSID_DRIVER_TYPE_CYW20707,	/* CYW20707 driver */
	IAXXX_SYSID_DRIVER_TYPE_MAC,		/* MAC driver */
	IAXXX_SYSID_DRIVER_TYPE_BQ27425,	/* BQ27425 driver */
	IAXXX_SYSID_DRIVER_TYPE_SENSOR,		/* sensor driver */
	IAXXX_SYSID_DRIVER_TYPE_DMA_STRM,	/* DMA Stream driver */
	IAXXX_SYSID_DRIVER_TYPE_CPUSTRMDRV,	/* CPU stream driver */
...
enum sysid_iaxxx_device_type_e {
	IAXXX_SYSID_DEVICE_TYPE_BUTTON,		/* Button device */
	IAXXX_SYSID_DEVICE_TYPE_LED,		/* LED device */
	IAXXX_SYSID_DEVICE_TYPE_FLASH,		/* Flash device */
	IAXXX_SYSID_DEVICE_TYPE_CODEC,		/* CODEC device */
	IAXXX_SYSID_DEVICE_TYPE_SENSOR,		/* Sensor device */
	IAXXX_SYSID_DEVICE_TYPE_INPUT_PIN,	/* Input pin device */
	IAXXX_SYSID_DEVICE_TYPE_OUTPUT_PIN,	/* Output pin device */
	IAXXX_SYSID_DEVICE_TYPE_STMR_TMR,	/* STMR timer device */
	IAXXX_SYSID_DEVICE_TYPE_STMR_PT,	/* STRM PT device */
	IAXXX_SYSID_DEVICE_TYPE_INTERFACE,	/* Interface device */
	IAXXX_SYSID_DEVICE_TYPE_USB,		/* USB device */
	IAXXX_SYSID_DEVICE_TYPE_BT,		/* Bluetooth device */
	IAXXX_SYSID_DEVICE_TYPE_BATTERY,	/* Battery Fuel Gauge Device */
...
enum sysid_special_type_e {
	IAXXX_SYSID_SPECIAL_TYPE_INVALID = 0,	/* Invalid resource */
	IAXXX_SYSID_SPECIAL_TYPE_HOST,		/* Special resource Host */
	IAXXX_SYSID_SPECIAL_TYPE_ALL = 0xF,	/* Use for broadcast */
 ...
 ****************************************************************************/
enum sysid_dir_e {
	IAXXX_SYSID_DIR_IN = 0,   /* Input direction */
	IAXXX_SYSID_DIR_OUT,       /* Output direction */
...
/** Bit offset of the 'module type' field in the module instance system id
 */
#define IAXXX_SYSID_POS_MODULE_TYPE               (4)
/** Bit mask of the 'module type' field in the module instance system id
 */
...
/** Bit offset of the 'channel id' field in the channel system id
 */
...
/** Bit offset of the 'channel endpoint index' field in the channel system id
 */
#define IAXXX_SYSID_POS_CHANNEL_EP_INDEX          (0)
/** Bit mask of the 'channel endpoint index' field in the channel system id
 */
...
/** Bit mask of the 'tunnel endpoint direction' field in the tunnel system id
 */
#define IAXXX_SYSID_MASK_TUNNEL_EP_DIR            (0x0020)

/** Bit offset of the 'tunnel endpoint index' field in the tunnel system id
 */
#define IAXXX_SYSID_POS_TUNNEL_EP_INDEX           (0)
/** Bit mask of the 'tunnel endpoint index' field in the tunnel system id
 */
...
/** Bit mask of the 'BT endpoint index' field in the BT endpoint system id
 */
 ...
 * bits   4           3        3      1      5
 */
/** Bit offset of the 'debug proc ' field in the debug endpoint system id
 */
#define IAXXX_SYSID_POS_DEBUG_PROC_ID             (9)
/** Bit mask of the 'debug proc' field in the debug endpoint system id
 */
#define IAXXX_SYSID_MASK_DEBUG_PROC_ID            (0x0E00)

/** Bit offset of the 'debug type' field in the debug endpoint system id
 */
#define IAXXX_SYSID_POS_DEBUG_TYPE_DIR            (6)
/** Bit mask of the 'debug type' field in the debug endpoint system id
 */
...
/** Bit mask of the 'device id' field in the device system id  */
#define IAXXX_SYSID_MASK_DEVICE_ID                (0x0FC0)

/** Bit offset of the 'device instance' field in the device system id
 */
#define IAXXX_SYSID_POS_DEVICE_INST               (0)
/** Bit mask of the 'device instance' field in the device system id
 */
...
#define IAXXX_SYSID_GET_RESOURCE_TYPE(id)                             \
	(((id) & IAXXX_SYSID_MASK_RESOURCE_TYPE) >>		\
	IAXXX_SYSID_POS_RESOURCE_TYPE)

/** Evaluates to true if the system id is special resource system id
 */
...
/** Evaluates to true if the system id is device (peripheral) system id
 */
...
#define IAXXX_SYSID_GET_SPECIAL_TYPE(sysId)                         \
	(((sysId) & IAXXX_SYSID_MASK_SPECIAL_TYPE) >>		\
...
/** Get the special resource type host's ctrl Id from the system id
 */
...
#define IAXXX_SYSID_GET_DRIVER_TYPE(sysId)                          \
	(((sysId) & IAXXX_SYSID_MASK_DRIVER_TYPE) >>		\
	IAXXX_SYSID_POS_DRIVER_TYPE)
/** Get the driver instance index from the driver system id
 */
...
/** Get the module processor id from the module instance system id
 */
...
/** Get the module instance number from the module instance system id
 */
...
#define IAXXX_SYSID_GET_PLUGIN_EP_DIR(sysId)                              \
	(((sysId) & IAXXX_SYSID_MASK_PLUGIN_EP_DIR) >>			\
	IAXXX_SYSID_POS_PLUGIN_EP_DIR)
/** Get the plugin endpoint index from the plugin (endpoint) system id
 */
#define IAXXX_SYSID_GET_PLUGIN_EP_INDEX(sysId)                            \
	(((sysId) & IAXXX_SYSID_MASK_PLUGIN_EP_INDEX) >>		\
	IAXXX_SYSID_POS_PLUGIN_EP_INDEX)
...
/** Get the channel endpoint direction from the channel (endpoint) system id
 */
#define IAXXX_SYSID_GET_CHANNEL_EP_DIR(sysId)                                \
	(((sysId) & IAXXX_SYSID_MASK_CHANNEL_EP_DIR) >>			\
	IAXXX_SYSID_POS_CHANNEL_EP_DIR)
/** Get the channel endpoint index from the channel (endpoint) system id
 */
...
/** Get the tunnel endpoint direction from the tunnel (endpoint) system id
 */
#define IAXXX_SYSID_GET_TUNNEL_EP_DIR(sysId)                              \
(((sysId) & IAXXX_SYSID_MASK_TUNNEL_EP_DIR)   >> IAXXX_SYSID_POS_TUNNEL_EP_DIR)
/** Get the tunnel endpoint index from the tunnel (endpoint) system id
 */
...
/** Generate the BT (endpoint) system id give the bt id, direction and index
 */
...
/** Get the bt endpoint direction from the bt (endpoint) system id
 */
...
/** Get the sensor endpoint direction from the sensor (endpoint) system id
 */
#define IAXXX_SYSID_GET_SENSOR_EP_DIR(sysId)                           \
(((sysId) & IAXXX_SYSID_MASK_SENSOR_EP_DIR) >> IAXXX_SYSID_POS_SENSOR_EP_DIR)
/** Get the sensor endpoint index from the sensor (endpoint) system id
 */
...
#define IAXXX_SYSID_GEN_DEBUG_SYSID(procId, type, dir, index)                 \
	...
	(((type)                     << IAXXX_SYSID_POS_DEBUG_TYPE_DIR)       \
	& IAXXX_SYSID_MASK_DEBUG_TYPE_DIR)    |                               \
...
/** Get the debug endpoint direction from the debug (endpoint) system id
 */
#define IAXXX_SYSID_GET_DEBUG_EP_DIR(sysId)                               \
(((sysId) & IAXXX_SYSID_MASK_DEBUG_EP_DIR) >> IAXXX_SYSID_POS_DEBUG_EP_DIR)
/** Get the debug endpoint index from the debug (endpoint) system id
 */
...
/** Generate the device system id given the device id and instance number
 */
