...
typedef enum _workload_status {
	...
	// Reject Skin TODO (masterwilliams) b/126249618 - depricate value
...
#define WORKLOAD_STATUS_STRINGS                                                \
	{                                                                      \
		"NO_STATUS", "PASS", "ERROR", "REJECT", "REJECT_NO_FACE",      \
			"REJECT_MULTIFACE", "REJECT_FACE_CAPACITY",            \
			"REJECT_NO_ATTENTION", "REJECT_SKIN",                  \
			"REJECT_DEPTH_MAP", "REJECT_TOO_SMALL",                \
			"REJECT_CLIPPED_LEFT", "REJECT_CLIPPED_RIGHT",         \
			"REJECT_CLIPPED_TOP", "REJECT_CLIPPED_BOTTOM",         \
			"REJECT_TOO_DARK", "REJECT_TOO_BRIGHT",                \
			"REJECT_TILT_ANGLE", "REJECT_PAN_ANGLE",               \
	}
