...
#define IAXXX_SYSID_PLUGIN_INSTANCE_0 \
	IAXXX_SYSID_GEN_PLUGIN_SYSID(0, \
				IAXXX_SYSID_DIR_OUT, \
				IAXXX_SYSID_EP_INDEX_PLUGIN_INSTANCE)
#define IAXXX_SYSID_PLUGIN_INSTANCE_1 \
	IAXXX_SYSID_GEN_PLUGIN_SYSID(1, \
				IAXXX_SYSID_DIR_OUT, \
				IAXXX_SYSID_EP_INDEX_PLUGIN_INSTANCE)
#define IAXXX_SYSID_PLUGIN_INSTANCE_2 \
	IAXXX_SYSID_GEN_PLUGIN_SYSID(2, \
				IAXXX_SYSID_DIR_OUT, \
				IAXXX_SYSID_EP_INDEX_PLUGIN_INSTANCE)
#define IAXXX_SYSID_PLUGIN_INSTANCE_3 \
	IAXXX_SYSID_GEN_PLUGIN_SYSID(3, \
				IAXXX_SYSID_DIR_OUT, \
				IAXXX_SYSID_EP_INDEX_PLUGIN_INSTANCE)
#define IAXXX_SYSID_PLUGIN_INSTANCE_4 \
	IAXXX_SYSID_GEN_PLUGIN_SYSID(4, \
				IAXXX_SYSID_DIR_OUT, \
				IAXXX_SYSID_EP_INDEX_PLUGIN_INSTANCE)
#define IAXXX_SYSID_PLUGIN_INSTANCE_5 \
	IAXXX_SYSID_GEN_PLUGIN_SYSID(5, \
				IAXXX_SYSID_DIR_OUT, \
				IAXXX_SYSID_EP_INDEX_PLUGIN_INSTANCE)
#define IAXXX_SYSID_PLUGIN_INSTANCE_6 \
	IAXXX_SYSID_GEN_PLUGIN_SYSID(6, \
				IAXXX_SYSID_DIR_OUT, \
				IAXXX_SYSID_EP_INDEX_PLUGIN_INSTANCE)
#define IAXXX_SYSID_PLUGIN_INSTANCE_7 \
	IAXXX_SYSID_GEN_PLUGIN_SYSID(7, \
				IAXXX_SYSID_DIR_OUT, \
				IAXXX_SYSID_EP_INDEX_PLUGIN_INSTANCE)
#define IAXXX_SYSID_PLUGIN_INSTANCE_8 \
	IAXXX_SYSID_GEN_PLUGIN_SYSID(8, \
				IAXXX_SYSID_DIR_OUT, \
				IAXXX_SYSID_EP_INDEX_PLUGIN_INSTANCE)
...
#define IAXXX_SYSID_SENSOR_OUTPUT_0 \
	IAXXX_SYSID_GEN_SENSOR_SYSID(0, IAXXX_SYSID_DIR_OUT, 0)
#define IAXXX_SYSID_SENSOR_OUTPUT_1 \
	IAXXX_SYSID_GEN_SENSOR_SYSID(0, IAXXX_SYSID_DIR_OUT, 1)
#define IAXXX_SYSID_SENSOR_OUTPUT_2 \
	IAXXX_SYSID_GEN_SENSOR_SYSID(0, IAXXX_SYSID_DIR_OUT, 2)
#define IAXXX_SYSID_SENSOR_OUTPUT_3 \
	IAXXX_SYSID_GEN_SENSOR_SYSID(0, IAXXX_SYSID_DIR_OUT, 3)
