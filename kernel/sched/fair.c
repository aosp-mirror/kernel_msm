				   ...
				   bool prefer_high_cap)
{
	...
	*backup_cpu = -1;
	...
	do {
		 ...
		 * break from searching more groups based on the
		 * stune.prefer_high_cap and group cpu capacity. For
		 * !prefer_idle && prefer_high_cap case, don't iterate lower
		 * capacity CPUs unless the task can't be accommodated in the
		 * higher capacity CPUs.
		 */
