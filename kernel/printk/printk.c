...
static struct printk_log *asus_log_from_idx(u32 idx, bool logbuf, int mode)
{
...
{
	return asus_log_from_idx(idx, true, 0);
}
...
{
	return asus_log_next(idx, true, 0);
}
