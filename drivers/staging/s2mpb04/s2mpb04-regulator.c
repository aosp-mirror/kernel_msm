...
static const unsigned int s2mpb04_ldo1_vtbl[] = { 1800000 };
static const unsigned int s2mpb04_ldo2_vtbl[] = { 600000 };
static const unsigned int s2mpb04_ldo3_vtbl[] = { 750000 };
static const unsigned int s2mpb04_ldo4_vtbl[] = { 850000 };
static const unsigned int s2mpb04_ldo5_vtbl[] = { 1800000 };
static const unsigned int s2mpb04_smps1_vtbl[] = { 750000 };
static const unsigned int s2mpb04_smps2_vtbl[] = { 850000 };
static const unsigned int s2mpb04_smps3_vtbl[] = { 1100000 };
...
static struct regulator_desc
	...
	[S2MPB04_ID_SMPS3] = {
		.name = S2MPB04_REGLTR_NAME_SMPS3,
		.id = S2MPB04_ID_SMPS3,
		.ops = &s2mpb04_regulator_ops,
		.n_voltages = ARRAY_SIZE(s2mpb04_smps3_vtbl),
		.volt_table = s2mpb04_smps3_vtbl,
		.enable_time = 200,
		.type = REGULATOR_VOLTAGE,
		.owner = THIS_MODULE,
	},
	[S2MPB04_ID_LDO1] = {
		...
		.id = S2MPB04_ID_LDO1,
		.ops = &s2mpb04_regulator_ops,
		.n_voltages = ARRAY_SIZE(s2mpb04_ldo1_vtbl),
		.volt_table = s2mpb04_ldo1_vtbl,
		.enable_time = 200,
		.type = REGULATOR_VOLTAGE,
		.owner = THIS_MODULE,
	},
	[S2MPB04_ID_LDO2] = {
		...
		.id = S2MPB04_ID_LDO2,
		.ops = &s2mpb04_regulator_ops,
		.n_voltages = ARRAY_SIZE(s2mpb04_ldo2_vtbl),
		.volt_table = s2mpb04_ldo2_vtbl,
		.enable_time = 200,
		.type = REGULATOR_VOLTAGE,
		.owner = THIS_MODULE,
	},
	[S2MPB04_ID_LDO3] = {
		.name = S2MPB04_REGLTR_NAME_LDO3,
		.id = S2MPB04_ID_LDO3,
		.ops = &s2mpb04_regulator_ops,
		.n_voltages = ARRAY_SIZE(s2mpb04_ldo3_vtbl),
		.volt_table = s2mpb04_ldo3_vtbl,
		.enable_time = 200,
		.type = REGULATOR_VOLTAGE,
		.owner = THIS_MODULE,
	},
	[S2MPB04_ID_LDO4] = {
		.name = S2MPB04_REGLTR_NAME_LDO4,
		.id = S2MPB04_ID_LDO4,
		.ops = &s2mpb04_regulator_ops,
		.n_voltages = ARRAY_SIZE(s2mpb04_ldo4_vtbl),
		.volt_table = s2mpb04_ldo4_vtbl,
		.enable_time = 200,
		.type = REGULATOR_VOLTAGE,
		.owner = THIS_MODULE,
	},
	[S2MPB04_ID_LDO5] = {
		.name = S2MPB04_REGLTR_NAME_LDO5,
		.id = S2MPB04_ID_LDO5,
		.ops = &s2mpb04_regulator_ops,
		.n_voltages = ARRAY_SIZE(s2mpb04_ldo5_vtbl),
		.volt_table = s2mpb04_ldo5_vtbl,
		.enable_time = 200,
		.type = REGULATOR_VOLTAGE,
		.owner = THIS_MODULE,
	},
...
static int s2mpb04_regulator_get_voltage(struct regulator_dev *rdev)
{
	...
	case S2MPB04_ID_SMPS2:
		...
		vsel = reg_data;
		break;
	case S2MPB04_ID_SMPS3:
		ret = s2mpb04_read_byte(s2mpb04_core, S2MPB04_REG_BUCK3_OUT,
					&reg_data);
		if (ret)
			return ret;
		vbase = 300000;
	...
	case S2MPB04_ID_LDO2:
		...
		vsel = reg_data & 0x3F;
		break;
	case S2MPB04_ID_LDO3:
		ret = s2mpb04_read_byte(s2mpb04_core, S2MPB04_REG_LDO3_CTRL,
					&reg_data);
		if (ret)
			return ret;
		vbase = 300000;
		...
		vsel = reg_data & 0x3F;
		break;
	case S2MPB04_ID_LDO4:
		ret = s2mpb04_read_byte(s2mpb04_core, S2MPB04_REG_LDO4_CTRL,
					&reg_data);
		if (ret)
			return ret;
		vbase = 400000;
		...
		vsel = reg_data & 0x3F;
		break;
	case S2MPB04_ID_LDO5:
		ret = s2mpb04_read_byte(s2mpb04_core, S2MPB04_REG_LDO5_CTRL,
					&reg_data);
		if (ret)
			return ret;
		vbase = 700000;
...
static int s2mpb04_regulator_enable(struct regulator_dev *rdev)
{
	...
	case S2MPB04_ID_SMPS2:
		...
		break;
	case S2MPB04_ID_SMPS3:
		ret = s2mpb04_write_byte(s2mpb04_core, S2MPB04_REG_BUCK3_CTRL,
					 0xD8);
		break;
	case S2MPB04_ID_LDO1:
	...
	case S2MPB04_ID_LDO2:
		...
		break;
	case S2MPB04_ID_LDO3:
		ret = s2mpb04_write_byte(s2mpb04_core, S2MPB04_REG_LDO3_CTRL,
					 0xA4);
		break;
	case S2MPB04_ID_LDO4:
		ret = s2mpb04_write_byte(s2mpb04_core, S2MPB04_REG_LDO4_CTRL,
					 0xA4);
		break;
	case S2MPB04_ID_LDO5:
		ret = s2mpb04_write_byte(s2mpb04_core, S2MPB04_REG_LDO5_CTRL,
					 0xEC);
		break;
	default:
		return -EINVAL;
