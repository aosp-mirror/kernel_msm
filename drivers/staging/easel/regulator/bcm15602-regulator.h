...
#define BCM15602_ADC_SCALE_ASR_CURR     3512 /* in mA */
#define BCM15602_ADC_SCALE_SDSR_CURR    2106 /* in mA */
#define BCM15602_ADC_SCALE_SDLDO_CURR   523  /* in mA */
#define BCM15602_ADC_SCALE_IOLDO_CURR   523  /* in mA */
#define BCM15602_ADC_SCALE_VBAT         4800 /* in mV */
#define BCM15602_ADC_SCALE_PTAT         1200 /* in mV */
...
#define BCM15602_HK_TH_ASR_MSTR_CURR   \
	(2500 * 1023 / BCM15602_ADC_SCALE_ASR_CURR)
#define BCM15602_HK_TH_ASR_SLV_CURR    \
	(2500 * 1023 / BCM15602_ADC_SCALE_ASR_CURR)
#define BCM15602_HK_TH_SDSR_CURR       \
	(1200 * 1023 / BCM15602_ADC_SCALE_SDSR_CURR)
#define BCM15602_HK_TH_SDLDO_CURR      \
	(100 * 1023 / BCM15602_ADC_SCALE_SDLDO_CURR)
#define BCM15602_HK_TH_IOLDO_CURR      \
	(100 * 1023 / BCM15602_ADC_SCALE_IOLDO_CURR)
#define BCM15602_HK_TH_VBAT_UNDERV0    \
	(3200 * 1023 / BCM15602_ADC_SCALE_VBAT)
#define BCM15602_HK_TH_VBAT_UNDERV1    \
	(3000 * 1023 / BCM15602_ADC_SCALE_VBAT)
#define BCM15602_HK_TH_VBAT_UNDERV2    \
	(2800 * 1023 / BCM15602_ADC_SCALE_VBAT)
#define BCM15602_HK_TH_PTAT_OVERT      \
	(TEMP_TO_PTAT_CODE(65) / BCM15602_ADC_SCALE_PTAT)
#define BCM15602_HK_TH_PTAT_UNDERT     \
	(TEMP_TO_PTAT_CODE(45) / BCM15602_ADC_SCALE_PTAT)
