...
static struct device_attribute sop716_device_attrs[] = {
	...
	__ATTR(set_time, S_IRUGO | S_IWUSR,
				NULL, sop716_time_store),
	__ATTR(motor_init, S_IRUGO | S_IWUSR,
				NULL, sop716_motor_init_store),
	__ATTR(motor_move, S_IRUGO | S_IWUSR,
				NULL, sop716_motor_move_store),
	__ATTR(motor_move_all, S_IRUGO | S_IWUSR,
				NULL, sop716_motor_move_all_store),
	__ATTR(get_hands_position, S_IRUGO | S_IWUSR,
				sop716_hands_position_show, NULL),
	__ATTR(get_time, S_IRUGO | S_IWUSR,
				sop716_get_time_show, NULL),
	__ATTR(get_version, S_IRUGO | S_IWUSR,
				sop716_get_version_show, NULL),
};
