...
#define AB_TMU_BUF_SLOPE_SEL		GENMASK(11, 8)
#define AB_TMU_BUF_SLOPE_SEL_VAL	0x5
...
#define AB_TMU_AVG_CTRL			0x38
#define AB_TMU_AVG_MODE			GENMASK(2, 0)
#define AB_TMU_EN_DEM			BIT_MASK(4)
