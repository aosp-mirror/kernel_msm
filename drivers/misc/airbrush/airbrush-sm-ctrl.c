...
static struct block_property fsys_property_table[] = {
	...
	/* GEN3L1 */
	BLK_(303, Normal,        L1,  0, on,  0_85, on,  4000,  0, 0, 0, 3),
	/* GEN3L1.2 */
...
static struct chip_to_block_map chip_state_map[] = {
	...
	/* Active */
	CHIP_TO_BLOCK_MAP_INIT(400, 300, 300, 305, 305, 304, 302),
	CHIP_TO_BLOCK_MAP_INIT(401, 301, 301, 305, 305, 304, 302),
	CHIP_TO_BLOCK_MAP_INIT(402, 302, 302, 305, 305, 304, 303),
	CHIP_TO_BLOCK_MAP_INIT(403, 303, 303, 305, 305, 304, 303),
	CHIP_TO_BLOCK_MAP_INIT(404, 304, 305, 305, 305, 304, 303),
	CHIP_TO_BLOCK_MAP_INIT(405, 305, 302, 305, 305, 304, 303),
	CHIP_TO_BLOCK_MAP_INIT(406, 302, 305, 305, 305, 303, 303),
	CHIP_TO_BLOCK_MAP_INIT(407, 305, 303, 305, 305, 304, 303),
	CHIP_TO_BLOCK_MAP_INIT(408, 303, 305, 305, 305, 303, 303),
	CHIP_TO_BLOCK_MAP_INIT(409, 305, 305, 305, 305, 303, 303),


	/* IPU Only */
	CHIP_TO_BLOCK_MAP_INIT(500, 300, 200, 305, 305, 304, 302),
	CHIP_TO_BLOCK_MAP_INIT(501, 301, 200, 305, 305, 304, 302),
	...
	/* TPU Only */
	CHIP_TO_BLOCK_MAP_INIT(600, 200, 300, 305, 305, 304, 302),
	CHIP_TO_BLOCK_MAP_INIT(601, 200, 301, 305, 305, 304, 302),
	CHIP_TO_BLOCK_MAP_INIT(602, 200, 302, 305, 305, 304, 303),
	CHIP_TO_BLOCK_MAP_INIT(603, 200, 303, 305, 305, 304, 303),
	CHIP_TO_BLOCK_MAP_INIT(604, 200, 305, 305, 305, 304, 303),
	CHIP_TO_BLOCK_MAP_INIT(605, 200, 305, 305, 305, 303, 303),
	...
	/* IPU Only - Low DRAM */
	CHIP_TO_BLOCK_MAP_INIT(800, 300, 200, 101, 100, 304, 300),
