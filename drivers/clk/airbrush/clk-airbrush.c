...
static const struct airbrush_gate_clock ipu_gate_clks[] = {
	...
	GATE(0, "clk_blk_ipu_uid_ipu_ipclkport_clk_ipu", "mout_ipu_aonclk_pllclk1", CLK_CON_GAT_CLK_BLK_IPU_UID_IPU_IPCLKPORT_CLK_IPU, 21, CLK_IGNORE_UNUSED, 0),
...
static const struct airbrush_gate_clock tpu_gate_clks[] = {
	...
	GATE(0, "clk_blk_tpu_uid_tpu_ipclkport_clk_tpu", "mout_tpu_aonclk_pllclk",  CLK_CON_GAT_CLK_BLK_TPU_UID_TPU_IPCLKPORT_CLK_TPU, 21, CLK_IGNORE_UNUSED, 0),
