...
#define    LOOP_NUM_HX         2217          // 18.014kHz/0.130kHz*16times
#define    LOOP_FREQ_HX        0x00EC794E    // 130Hz = Freq*80000000h/Fs(18k)
...
#define    LOOP_NUM_HY         2217           // 18.014kHz/0.130kHz*16times
#define    LOOP_FREQ_HY        0x00EC794E    // 130Hz = Freq*80000000h/Fs(18k)
...
#ifdef SEL_CLOSED_AF
#define    LOOP_NUM_HZ         1695          // 18.014kHz/0.170kHz*16times
#define    LOOP_FREQ_HZ        0x01353BE8    // 170Hz = Freq*80000000h/Fs(18k)
...
//================================================
//#ifdef __OISCMD__
const ADJ_HALL Emily_HallCalParameter[] = {
{
/****** PROTO TYPE ******/
/* BiasInit */          XY_BIAS,
/* OffsetInit */        XY_OFST,
...
/* ZHighMargin */       (0x0510/* 13% */),
/* ZLowMargin */        (0x0510/* 13% */),
#endif
}, {
/****** P1 ******/
/* BiasInit */          XY_BIAS,
...
const ADJ_LOPGAN Emily_LoopGainParameter[] = {
{
/****** PROTO TYPE ******/
/* Hxgain */            SXGAIN_LOP,
/* Hygain */            SYGAIN_LOP,
...
/* XNoiseGain */      LOOP_GAIN_HX,
/* XGap  */           GAIN_GAP_HX,
/* YNoiseNum */       2306,       // LOOP_NUM_HY  18.014kHz/0.125kHz*16times
/* YNoiseFreq */      0x00E360F2, // LOOP_FREQ_HY 125Hz = Freq*80000000h/Fs(18k)
/* YNoiseGain */      LOOP_GAIN_HY,
/* YGap  */           GAIN_GAP_HY,
/* XJudgeHigh */      LOOP_MAX_X,
/* XJudgeLow  */      LOOP_MIN_X,
...
const ADJ_LINEARITY_MIXING Emily_LinMixParameter[] = {
{
/****** PROTO TYPE ******/
...
//#else     // __OISCMD__
//extern const ADJ_HALL Emily_HallCalParameter[];
//extern const ADJ_LOPGAN Emily_LoopGainParameter[];
//extern const ADJ_LINEARITY_MIXING Emily_LinMixParameter[];
//#endif    // __OISCMD__
//
//#ifdef __OISFLSH__
const ADJ_TEMP_COMPENSATION Emily_TempCompParameter[] = {
{
/****** PROTO TYPE ******/
/* rcodeX */     TEMP_RCODEX,
/* rcodeY */     TEMP_RCODEY,
...
//#else     // __OISFLSH__
//extern const ADJ_TEMP_COMPENSATION Emily_TempCompParameter[];
//#endif    // __OISFLSH__
