...
static struct attribute *sensors_class_attributes[] = {
	&dev_attr_name.attr,
...
static const struct attribute_group sensors_class_group = {
	.attrs = sensors_class_attributes,
};


static const struct attribute_group *sensors_dev_group[] = {
	&sensors_class_group,
	NULL,
};
...
static int __init sensors_init(void)
{
	...
	sensors_class->dev_groups = sensors_dev_group;
	return 0;
}
