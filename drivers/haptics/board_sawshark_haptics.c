...
static struct drv2605_platform_data  drv2605_plat_data = {
        .GpioEnable = 68,                       //enable the chip
        .GpioTrigger = 69,                      //external trigger pin, (0: internal trigger)
...
static void __init hw_add_i2c_haptics_device(void)
{
...
static int __init hw_add_haptics_device(void)
{
	hw_add_i2c_haptics_device();
	return 0;
}
postcore_initcall(hw_add_haptics_device);
