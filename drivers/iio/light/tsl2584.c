 ...
 */
static void taos_defaults(struct tsl2584_chip *chip)
{
...
static const struct attribute_group tsl2584_attribute_group = {
...
static const struct iio_info tsl2584_info = {
	.attrs = &tsl2584_attribute_group,
		      ...
		      const struct i2c_device_id *idp)
{
	...
	if (!indio_dev){
		dev_err(&clientp->dev, "devm_iio_device_alloc failed\n");
		return -ENOMEM;
		}
...
MODULE_DESCRIPTION("TAOS tsl2584 ambient light sensor driver");
MODULE_LICENSE("GPL");
