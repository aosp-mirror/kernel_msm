...
static void ufshpb_map_req_compl_fn(struct request *req, blk_status_t status)
{
	struct ufshpb_map_req *map_req =
		...
		struct ufshpb_subregion *cp)
{
	...
	req.cmd_flags = REQ_OP_READ | REQ_OP_SCSI_IN;
	req.rq_flags = RQF_SOFTBARRIER | RQF_QUIET | RQF_PREEMPT;
