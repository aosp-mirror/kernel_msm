...
static int tps61099_regulator_enable(struct regulator_dev *rdev)
{
...
static int tps61099_regulator_disable(struct regulator_dev *rdev)
{
	struct tps61099 *tps61099 = rdev_get_drvdata(rdev);
	int rc = 0;
...
static struct regulator_ops tps61099_reg_ops = {
	.enable = tps61099_regulator_enable,
	.disable = tps61099_regulator_disable,
...
static int tps61099_probe(struct platform_device *pdev)
{
	...
	tps61099->rdesc.ops = &tps61099_reg_ops;
