...
#else
#define	SPS_DBG3(dev, x...)		pr_debug(x)
#define	SPS_DBG2(dev, x...)		pr_debug(x)
#define	SPS_DBG1(dev, x...)		pr_debug(x)
#define	SPS_DBG(dev, x...)		pr_debug(x)
#define	SPS_INFO(dev, x...)		pr_info(x)
#define	SPS_ERR(dev, x...)		pr_err(x)
