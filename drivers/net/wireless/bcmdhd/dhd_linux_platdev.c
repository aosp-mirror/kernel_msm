...
extern struct wifi_platform_data dhd_wlan_control;   //add by Jerry
extern struct resource dhd_wlan_resources;           //add by Jerry
#else
static bool dts_enabled = FALSE;
//struct resource dhd_wlan_resources = {0};                        //remove by Jerry
/*******************************************/
/*To adapt the MSM8908W, init the dhd_wlan_control*/
/*in the platform resource file dhd_custom_platdev.c  */
/*******************************************/
//#ifdef CUSTOMER_HW
//struct wifi_platform_data dhd_wlan_control = {0};           //remove by Jerry
//#endif
