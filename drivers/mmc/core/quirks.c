...
#ifndef SDIO_DEVICE_ID_BCM43430
#define SDIO_DEVICE_ID_BCM43430		43430
#endif
...
static const struct mmc_fixup mmc_fixup_methods[] = {
	...
	SDIO_FIXUP(SDIO_VENDOR_ID_BRCM, SDIO_DEVICE_ID_BCM43430,
		   add_quirk, MMC_QUIRK_DISABLE_UHS),
	END_FIXUP
};
