...
typedef enum jcop_dwnld_state{
	...
	/* jcop download complete in spi interface*/
...
struct pn544_i2c_platform_data {
	...
	/* gpio to give power to p61, only TEE should use this */
    unsigned int ese_pwr_gpio;
    unsigned int iso_rst_gpio; /* gpio used for ISO hard reset P73*/
	unsigned int clkreq_gpio; /* gpio used for bbclk request */
	const char *clk_src_name; /* name for request clk */
    bool clk_pin_voting; /* clk voting */
};
