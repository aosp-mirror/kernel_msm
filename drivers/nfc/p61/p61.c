...
#define P61_LOW_VOL_LEVEL 1800000
#define P61_HIGHT_VOL_LEVEL 1800000
        ...
        unsigned long arg)
{
    ...
    case P61_SET_PWR:
        if (arg == 2)
        {
            ...
            {
                ret = regulator_disable(p61_regulator);
                msleep(50);
       ...
       struct p61_dev *p61_dev, struct spi_device *spi)
{
    ...
    ret = regulator_set_voltage(p61_regulator, P61_LOW_VOL_LEVEL, P61_HIGHT_VOL_LEVEL);
    if (ret != 0)
    {
