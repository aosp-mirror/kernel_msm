...
static struct stc311x_platform_data stc3117_data = {
	...
	/*OCV curve example for a 4.35V li-ion battery*/
        .OCVValue[15] = 4299,             /* OCV curve value */
        .OCVValue[14] = 4190,             /* OCV curve value */
        .OCVValue[13] = 4098,             /* OCV curve value */
        .OCVValue[12] = 3977,             /* OCV curve value */
        .OCVValue[11] = 3942,             /* OCV curve value */
        .OCVValue[10] = 3902,             /* OCV curve value */
        .OCVValue[9] = 3839,              /* OCV curve value */
        .OCVValue[8] = 3800,              /* OCV curve value */
        .OCVValue[7] = 3768,              /* OCV curve value */
        ...
        .OCVValue[1] = 3621,              /* OCV curve value */
