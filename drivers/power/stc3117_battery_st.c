...
static struct stc311x_platform_data stc3117_data = {
	...
	.OCVValue[15] = 4207,            /* OCV curve adjustment */
	.OCVValue[14] = 4111,            /* OCV curve adjustment */
	.OCVValue[13] = 4019,            /* OCV curve adjustment */
	.OCVValue[12] = 3941,            /* OCV curve adjustment */
	.OCVValue[11] = 3907,            /* OCV curve adjustment */
	.OCVValue[10] = 3866,            /* OCV curve adjustment */
	.OCVValue[9] = 3820,             /* OCV curve adjustment */
	.OCVValue[8] = 3790,             /* OCV curve adjustment */
	.OCVValue[7] = 3763,             /* OCV curve adjustment */
	.OCVValue[6] = 3747,             /* OCV curve adjustment */
	.OCVValue[5] = 3733,             /* OCV curve adjustment */
	.OCVValue[4] = 3708,             /* OCV curve adjustment */
	.OCVValue[3] = 3684,             /* OCV curve adjustment */
	.OCVValue[2] = 3682,             /* OCV curve adjustment */
	.OCVValue[1] = 3641,             /* OCV curve adjustment */
	.OCVValue[0] = 3500,             /* OCV curve adjustment */
...
static ssize_t sculld_show_CEI_SOC_Set(struct device *dev,
...
static ssize_t sculld_store_CEI_SOC_Set(struct device *dev,
						struct device_attribute *attr,
						const char *buf, size_t count)
{
	int ret;

	ret = kstrtol(buf, 10, &CEI_SOC_Set);
	if ((CEI_SOC_Set >= 0) && (CEI_SOC_Set <= 100))
		STC311x_SetSOC(CEI_SOC_Set * 512);

	return count;
}

static DEVICE_ATTR(CEI_SOC_Set, 0664 ,
		   sculld_show_CEI_SOC_Set,
		   sculld_store_CEI_SOC_Set);

static ssize_t sculld_show_CEI_Temperature(struct device *dev,
						struct device_attribute *attr,
						char *buf)
{
	return snprintf(buf, 10, "%ld\n", CEI_Temperature);
...
static ssize_t sculld_store_CEI_Temperature(struct device *dev,
						struct device_attribute *attr,
						const char *buf, size_t count)
{
	int ret;

	ret = kstrtol(buf, 10, &CEI_Temperature);

	return count;
}

static DEVICE_ATTR(CEI_Temperature, 0664 ,
