...
static unsigned char CTPM_FW[] = {
	#include "L8150-K71114_FT3327_V03_D02_20160813_app.i"
};
...
void fts_update_fw_ver(struct fts_ts_data *data)
{
	...
	dev_info(&client->dev, "Firmware version = 0x%02x.%d.%d\n",
...
int fts_ctpm_auto_upgrade(struct i2c_client *client)
{
	...
	//lct.lixiaojun add:TP内固件版本不等于host端时，烧写host端固件至TP中  2016-06-02
