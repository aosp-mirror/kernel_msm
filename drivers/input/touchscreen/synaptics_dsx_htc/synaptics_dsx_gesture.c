...
static struct device_attribute attrs[] = {
	__ATTR(engine_enable, S_IRUGO | S_IWUSR | S_IWGRP,
			synaptics_rmi4_show_error,
			udg_sysfs_engine_enable_store),
	__ATTR(detection_enable, S_IRUGO | S_IWUSR | S_IWGRP,
			synaptics_rmi4_show_error,
	...
	__ATTR(detection_index, S_IRUGO,
			...
			synaptics_rmi4_store_error),
	__ATTR(registration_enable, S_IRUGO | S_IWUSR | S_IWGRP,
			synaptics_rmi4_show_error,
			udg_sysfs_registration_enable_store),
	__ATTR(registration_begin, S_IRUGO | S_IWUSR | S_IWGRP,
			synaptics_rmi4_show_error,
	...
	__ATTR(template_detection, S_IRUGO,
			...
			synaptics_rmi4_store_error),
	__ATTR(template_index, S_IRUGO | S_IWUSR | S_IWGRP,
			synaptics_rmi4_show_error,
	...
	__ATTR(template_clear, S_IRUGO | S_IWUSR | S_IWGRP,
			synaptics_rmi4_show_error,
