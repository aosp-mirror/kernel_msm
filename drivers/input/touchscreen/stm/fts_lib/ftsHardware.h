...
//FLASH ADDRESS
#define FLASH_ADDR_CODE		0x00000000	///< address of code in FTI
#define FLASH_ADDR_CONFIG	0x00007C00	///< address of config in FTI
#define FLASH_ADDR_CX		0x00007000	///< address of Init data in FTI
...
#define FW_CX_VERSION		(16+4)	/* CX version offset in sec2 of FW */
/** @} */
