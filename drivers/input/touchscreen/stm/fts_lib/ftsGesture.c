...
static u8 gesture_mask[GESTURE_MASK_SIZE] = { 0 };								///< store the gesture bitmask which the host want to enable. If bit set 1 the corresponding gesture will be detected in Gesture Mode
