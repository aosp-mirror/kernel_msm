...
int fts_writeU8UX(u8 cmd, AddrSize addrSize, u64 address, u8 *data, int dataSize);																	//chunked version of fts_write
int fts_writeReadU8UX(u8 cmd, AddrSize addrSize, u64 address, u8* outBuf, int byteToRead, int hasDummyByte);										//chunked version of fts_writeRead
int fts_writeU8UXthenWriteU8UX(u8 cmd1, AddrSize addrSize1, u8 cmd2, AddrSize addrSize2, u64 address, u8 *data, int dataSize);						//chunked, write followed by another write
int fts_writeU8UXthenWriteReadU8UX(u8 cmd1, AddrSize addrSize1, u8 cmd2, AddrSize addrSize2, u64 address, u8 *outBuf, int count, int hasDummyByte);	//chunked, write followed by a writeRead
#endif